 ...
 */
class GeminiLiveAPI {
  constructor(proxyUrl, projectId, model, useGoogleAI = true) {
    this.proxyUrl = proxyUrl;
    this.projectId = projectId;
    this.model = model;
    this.useGoogleAI = useGoogleAI;
    this.modelUri = useGoogleAI
      ? `models/${this.model}`
      : `projects/${this.projectId}/locations/us-central1/publishers/google/models/${this.model}`;
    ...
    this.apiHost = useGoogleAI
      ? "generativelanguage.googleapis.com"
      : "us-central1-aiplatform.googleapis.com";
    this.serviceUrl = useGoogleAI
      ? `wss://${this.apiHost}/ws/google.ai.generativelanguage.v1beta.GenerativeService.BidiGenerateContent`
      : `wss://${this.apiHost}/ws/google.cloud.aiplatform.v1beta1.LlmBidiService/BidiGenerateContent`;
  ...
  setProjectId(projectId) {
    this.projectId = projectId;
    this.modelUri = this.useGoogleAI
      ? `models/${this.model}`
      : `projects/${this.projectId}/locations/us-central1/publishers/google/models/${this.model}`;
  }
